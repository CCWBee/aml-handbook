...
Interactive web version of the JFSC Handbook for the Prevention and Detection of Money Laundering, the Financing of Terrorism and the Proliferation of Weapons.

## Select Your Sector

Choose your sector to filter the handbook to only the sections relevant to you. Sections 1-11 apply to **all** regulated entities.

<div class="role-grid" markdown>

<div class="role-card" data-role="all" markdown>

**:material-shield: All Sectors**{ .role-card-title }

View the complete handbook (Sections 1-18)
</div>

<div class="role-card" data-role="fund-services" markdown>

**:material-chart-line: Fund Services**{ .role-card-title }

Sections 1-11 + Section 13
</div>

<div class="role-card" data-role="tcsp" markdown>

**:material-domain: TCSPs**{ .role-card-title }

Sections 1-11 + Section 12
</div>

<div class="role-card" data-role="estate-agents" markdown>

**:material-home: Estate Agents**{ .role-card-title }

Sections 1-11 + Section 14
</div>

<div class="role-card" data-role="high-value-dealers" markdown>

**:material-diamond-stone: High Value Dealers**{ .role-card-title }

Sections 1-11 + Section 14
</div>

<div class="role-card" data-role="lawyers" markdown>

**:material-gavel: Lawyers**{ .role-card-title }

Sections 1-11 + Section 15
</div>

<div class="role-card" data-role="accountants" markdown>

**:material-calculator: Accountants**{ .role-card-title }

Sections 1-11 + Section 16
</div>

<div class="role-card" data-role="npos" markdown>

**:material-heart: NPOs**{ .role-card-title }

Sections 1-11 + Section 17
</div>

<div class="role-card" data-role="aml-providers" markdown>

**:material-shield-check: AML Providers**{ .role-card-title }

Sections 1-11 + Section 18
</div>

</div>

<div id="role-confirmation" class="role-confirmation" style="display:none;" markdown>
</div>

<p style="text-align: center; margin: 1.5rem 0;">
  <a href="sections/01-introduction/" class="md-button md-button--primary start-reading-btn">
    Start Reading — Section 1: Introduction →
  </a>
</p>
